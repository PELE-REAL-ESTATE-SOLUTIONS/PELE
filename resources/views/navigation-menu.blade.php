<nav x-data="{ open: false }"
    class="sticky top-0 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 z-50">
        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden sm:block flex-shrink-0">
                <div class="flex space-x-4">
                    <x-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('buy')">
                        {{ __('BUY') }}
                    </x-nav-link>
                        ...
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                ...
                                <span class="inline-flex rounded-md">
                                    <button type="button"
                                        class="py-1 flex justify-center items-center text-custom-blue hover:opacity-80 transition-opacity">
    ...
    <div :class="{'absolute': open, 'hidden': ! open}"
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('rent')">
                {{ __('Rent') }}
            </x-responsive-nav-link>
